...
/*
    ...
    if (AInputEvent_getType(event) == AMOTION_EVENT_ACTION_POINTER_DOWN) {
    	...
    	__android_log_write(ANDROID_LOG_DEBUG, "engine_handle_input", "AMOTION_EVENT_ACTION_POINTER_DOWN");
...
void android_main(struct android_app* state) {
	...
	//int opened = openSLAsset(assetmgr, "amb_loop_003_40s.wav", 0);


	loadAllBuffers(assetmgr);

	__android_log_write(ANDROID_LOG_DEBUG, "NDK_debug_tag: ", "loadAllBuffers(assetmgr) called");
